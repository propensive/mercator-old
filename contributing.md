...
Firstly, thank you for taking an interesting in contributing! Mercator is an open-source project, and welcomes
...
Mercator is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.mercator:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.mercator:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/mercator` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Mercator does not use automatic code-formatting
...
development environment for all Mercator&rsquo;s users. Propensive O&Uuml; reserves the right to censure
